...
let baseDeDatos = [
  ...
  //basica/media superior/superior
  { id: 1, edad: 27-30, sexo: 'femenino', nivelEducativo: 'superior', ocupacion: 'desempleado', personalidad: 'extrovertida', pazInterior: 'calmado', enfoquePersonal: 'amigos', actividadDeportiva: 'moderada', gustoPorViajar: 'alto', gustoPorLeerMangas: 'leve', gustoPorVideojuegos: 'moderado', gustoPorMusicaRelajante: 'nulo', gustoPorMusicaAnimada: 'nulo', apegoReligion: 'nulo', apegoFamilia: 'moderado', gustoPorCine: 'alto', gustoPorLeer: 'moderado', habitosSueno: 'regulares', importanciaAmistad: 'alta', gustoPorMascotas: 'perros', importanciaSalud: 'alta', importanciaApariencia: 'media'},
  ...
  { id: 17, edad: 24-26, sexo: 'femenino', nivelEducativo: 'superior', ocupacion: 'desempleado', personalidad: 'extrovertida', pazInterior: 'calmado', enfoquePersonal: 'trabajo', actividadDeportiva: 'alta', gustoPorViajar: 'alto', gustoPorLeerMangas: 'nulo', gustoPorVideojuegos: 'moderado', gustoPorMusicaRelajante: 'leve', gustoPorMusicaAnimada: 'leve', apegoReligion: 'nulo', apegoFamilia: 'moderado', gustoPorCine: 'moderado', gustoPorLeer: 'nulo', habitosSueno: 'regulares', importanciaAmistad: 'alta', gustoPorMascotas: 'perros', importanciaSalud: 'alta', importanciaApariencia: 'alta' },
